...
const Banner = () => {
  return (
    <div
      className="relative h-80 bg-cover bg-center mb-12 rounded-lg overflow-hidden shadow-lg"
    ...
    >
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center">
        ...
        <h1 className="text-5xl text-green-900 font-bold">AgroMart</h1>
        ...
        <Link
          to="/categories"
          className="mt-6 px-6 py-3 bg-yellow-400 text-black font-semibold rounded-lg hover:bg-yellow-500 transition"
        >
          Explore Marketplace
        </Link>
      </div>
